...
export const Sidebar = () => {
    ...
    return (
        <div className="sidebar">
            <div id="drawer-navigation" class="hidden fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-64 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
